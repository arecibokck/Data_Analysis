...
Plotting.plotConvolvedDistributionSampling(Solver)
...
UptoInitPos = 30; %in um
Plotting.plotEnvelopes(Solver, UptoInitPos)
...
MaxHoldTime = 5; %in ms
Plotting.plotPhaseSpaceAnalysis(Solver, MaxHoldTime)
