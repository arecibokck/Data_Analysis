...
HoldTimeRange = [0.1 3];
PlotType = 'Ratio';
plotRMSSpreadEvolutionForDifferentTemps(tspan, HoldTimeRange, Spreads, NumberOfAtoms, FractionOfInitialPotential, 0.09:0.04:0.25, PlotType)
%% Plotting functions
...
function plotRMSSpreadEvolutionForDifferentTemps(tspan, HoldTimeRange, Spreads, NumberOfAtoms, FractionOfInitialPotential, GroundStatePopulation, PlotType)
    figure(9)
    clf
    %colours = {[0, 0.4470, 0.7410],[0.8500, 0.3250, 0.0980],[0.9290, 0.6940, 0.1250],[0.4940, 0.1840, 0.5560],[0.4660, 0.6740, 0.1880], [0.6350, 0.0780, 0.1840]};
    %set(gcf, 'defaultAxesColorOrder', [colours{1};colours{5}]);
