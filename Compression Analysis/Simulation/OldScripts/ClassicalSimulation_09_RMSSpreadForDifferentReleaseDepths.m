...
FractionOfInitialPotential = [0.05, 0.1, 0.5, 1];
Spreads = {};
for Index = 1:length(FractionOfInitialPotential)
    ...
    initialTemperature = sqrt(FractionOfInitialPotential(Index)) * initialTemperatureBeforeAdiabaticRampDown;
...
%%
plotRMSSpreadEvolutionForDifferentReleaseDepths(tspan, Spreads, NumberOfAtoms, FractionOfInitialPotential, GroundStatePopulation)
%% Plotting functions
