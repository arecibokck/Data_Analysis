...
function fast_FT(s , r, sam, folder, name)
    ...
    img_name = strcat(folder, name, '_DFT');
    print ('-dpng', img_name);
    close(gcf);
    ...
    csvwrite(strcat(folder, name, '_DFT.csv'), DFT_s);
    csvwrite(strcat(folder, name, '_DFT.csv'), DFT_r);
